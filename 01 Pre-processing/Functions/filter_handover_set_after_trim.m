function [handovers_out, inlier_idx, outlier_idx] = filter_handover_set_after_trim(handovers, std_tol, window, varargin)
...
t_len = length(handovers(1).signals.time.data);
t_idx = [1:t_len];
